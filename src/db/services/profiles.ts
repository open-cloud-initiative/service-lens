...
export const createProfile = async (opts: z.infer<typeof CreateProfileSchema>) =>
...
export const destroyProfile = async (opts: z.infer<typeof DestroyProfileSchema>) =>
    sequelize.transaction(async (transaction) => await Profile.destroy({ where: { id: opts }, transaction }))

export const findOneProfile = async (opts: z.infer<typeof FindOneProfileSchema>) =>
    await Profile.findOne({
        where: { id: opts },
        include: [{ model: ProfileQuestionChoice, include: [ProfileQuestion] }],
    })

export const findAndCountProfiles = async (opts: z.infer<typeof FindAndCountProfilesSchema>) =>
...
export const findAllProfilesQuestions = async (opts: z.infer<typeof FindAllProfilesQuestionsSchema>) =>
