...
export type ProfileCreationAttributes = Omit<ProfileAttributes, 'id' | 'createdAt' | 'updatedAt' | 'deletedAt'>
...
export class Profile extends Model<ProfileAttributes, ProfileCreationAttributes> {
    ...
    @BelongsToMany(() => ProfileQuestionChoice, () => ProfileQuestionAnswer, 'profileId', 'choiceId')
