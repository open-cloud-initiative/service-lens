...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        const profileQuestion = await queryInterface.bulkInsert('profiles-questions', [
            {
        ...
        const profileQuestionChoices = await queryInterface.bulkInsert('profiles-questions-choices', [
            {
                questionId: 1,
